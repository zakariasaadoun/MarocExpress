 ...
 * @author intel
 */
public final class UpdateClientA extends javax.swing.JFrame {
    ...
    public void affiche() {
        ...
        try {
            ...
            Logger.getLogger(UpdateClientA.class.getName()).log(Level.SEVERE, null, ex);
        }
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                        ...
                        .addComponent(btnValider, javax.swing.GroupLayout.PREFERRED_SIZE, 174, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(btnAnn)
                        .addGap(133, 133, 133))
    ...
    private void btnValiderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnValiderActionPerformed
        ...
        if (verifierField()) {
            try {
                PreparedStatement pstmt = con.prepareStatement("update client set nomcl=?, prenomcl=?, cinCl=?, telcl=?, emailcl=?, adresseCl=?, sexeCl=? where cinCl=?");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateClientA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UpdateClientA().setVisible(true);
            }
        });
    }
